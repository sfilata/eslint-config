...
export function typescript(
  ...
  return [
    ...
    {
      files: ['**/*.d.ts'],
      name: 'sfilata:typescript:dts-overrides',
      rules: {
    ...
    },
    {
      ...
      name: 'sfilata:typescript:tests-overrides',
      rules: {
    ...
    {
      files: ['**/*.js', '**/*.cjs'],
      name: 'sfilata:typescript:javascript-overrides',
      rules: {
